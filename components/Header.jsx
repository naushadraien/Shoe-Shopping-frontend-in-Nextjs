...
const Header = () => {
  ...
  useEffect(() => {
    ...
    //return for componentdidUnmount
    return () =>{
  ...
  return (
    ...
    >
      <Wrapper className="h-[60px] flex justify-between items-center">
        ...
        {/* show and hide mobile menu when when clicked on menu button in small devices */}
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          {/* adding mobile menu icon for small screen */}
          <div className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative -mr-2">
            {/* using ternary operator to check the condition */}
                {mobileMenu ? (
